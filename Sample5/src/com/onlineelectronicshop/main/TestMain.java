...
import com.onlineelectronicshop.daoImpl.AdminDao;
import com.onlineelectronicshop.daoImpl.CartDao;
import com.onlineelectronicshop.daoImpl.ComponentDao;
import com.onlineelectronicshop.daoImpl.PaymentDao;
...
//delete cart					
					...
					case 5:
//						comDao = new ComponentDao();
//	      				 System.out.println("Enter city name");
//	      				 String componentName=scan.nextLine();
//	      				List<Components> componentsList= comDao.
//						for (int i = 0; i < componentsList1.size(); i++) {
//							System.out.println(componentsList1.get(i));
//						}
//						break;
